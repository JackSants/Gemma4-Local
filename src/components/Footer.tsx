      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="mb-4">
              <h3 className="text-2xl font-bold">ModernSite</h3>
            ...
            <div className="flex space-x-4">
              ...
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.618 5.367 11.986 11.988 11.986 6.618 0 11.986-5.368 11.986-11.986C24.003 5.367 18.635.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.328-1.297L6.548 14.264c.515.515 1.169.772 1.901.772.732 0 1.386-.257 1.901-.772l1.427 1.427c-.88.807-2.031 1.297-3.328 1.297zm7.158 0c-1.297 0-2.448-.49-3.328-1.297l1.427-1.427c.515.515 1.169.772 1.901.772.732 0 1.386-.257 1.901-.772l1.427 1.427c-.88.807-2.031 1.297-3.328 1.297z"/>
                </svg>
              </a>
            </div>
          </div>
